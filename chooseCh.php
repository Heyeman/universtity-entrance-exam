...
?>
    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation" style="margin-bottom:50px;">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="NE_grade_12_NS.php"><i class="fa fa-edit fa-2x"></i>Grade 12 National Exams</a>
                            </li>
            ...
            <?php
            if (ucwords($subject) == 'Mathematics') {
                $g11Chapters = 9;
                $g12Chapters = 5;
            }
            if (ucwords($subject) == 'Physics') {
                $g11Chapters = 8;
                $g12Chapters = 4;
            }
            if (ucwords($subject) == 'Chemistry') {
                $g11Chapters = 6;
                $g12Chapters = 3;
            }
            if (ucwords($subject) == 'Biology') {
                $g11Chapters = 5;
                $g12Chapters = 2;
            }
            ?>
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Grade 11 <?php echo $subject . " "  ?> Chapters </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <?php for ($i = 1; $i <= $g11Chapters; $i++) {
                    ?>

                        <div class="col-lg-3 col-md-6">
                            <a href="byChapter.php?subject=<?php echo $subject; ?>&chapter=<?php echo $i; ?>&grade=11">
                                <div class="panel panel-red">
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col-xs-12 ">
                                                <div>
                                                    <h3>Try questions from Chapter <?php echo $i; ?> </h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Grade 12 <?php echo $subject . " "  ?> Chapters</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <?php for ($i = 1; $i <= $g12Chapters; $i++) {
                    ?>

                        <div class="col-lg-3 col-md-6">
                            <a href="byChapter.php?subject=<?php echo $subject; ?>&chapter=<?php echo $i; ?>&grade=12">
                                <div class="panel panel-red">
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col-xs-12 ">
