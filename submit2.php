                ...
                <form id="regForm" method="POST" action="submit.php?subject=<?php echo $subject; ?>&year=<?php echo $year; ?>">
                    ...
                    <div class='panel panel-default'>
                      ...
                      <div class='radio'>
                        ...
                        <a href='new.php?id=" . $id . "&grade=11' target='_blank' class='btn btn-xs btn-info'> grade 11 </a>
                        <a href='new.php?id=" . $id . "&grade=12' target='_blank' class='btn btn-xs btn-info'> grade 12 </a>
                        <a href='new.php?id=" . $id . "&grade=idk' target='_blank' class='btn btn-xs btn-info'>unknown</a>
