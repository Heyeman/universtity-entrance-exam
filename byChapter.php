    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <form id="regForm" method="POST" action="submitCh.php?subject=<?php echo $subject; ?>&grade=<?php echo $grade; ?>&chapter=<?php echo $chapter; ?>">
                        ...
                        <div class='form-group'>
                            <div class="panel-body">
                                ...
                                while ($fet = mysqli_fetch_assoc($return)) {
                                    ...
                                    echo "
							<label>" . $q . "(<strong>".$fet['Year']." </strong>) </label>
                      <div class='radio'>";
                                    if ($path != null) {
                                        echo "
