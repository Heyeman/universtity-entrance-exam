    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <form id="regForm" method="POST" action="submit.php?subject=<?php echo $subject; ?>&year=<?php echo $year; ?>">
                    ...
                    <div class='panel panel-default'>
                        ...
                        <div class='form-group'>
                            <div class="panel-body">
                                ...
                                $mysqli_id = mysqli_connect('localhost', 'root', '', 'CEE_National_Examinations');
                                ...
                                //	$r=mysqli_select_db('CEE_National_Examinations', $mysqli_id);



                                $return = mysqli_query($mysqli_id, "SELECT * from CEE_NATIONAL_EXAMINATION where Subject='$subject' AND Year='$year' and stream!='Social'");
                      ...
                      <div class='radio'>
                        ...
                        <a href='newch.php?id=" . $id . "&ch=1' target='_blank' class='btn btn-xs btn-info'> chap 1 </a>
                        <a href='newch.php?id=" . $id . "&ch=2' target='_blank' class='btn btn-xs btn-info'>chap2 </a>
                        <a href='newch.php?id=" . $id . "&ch=3' target='_blank' class='btn btn-xs btn-info'>chapt 3 </a>
                        <a href='newch.php?id=" . $id . "&ch=4' target='_blank' class='btn btn-xs btn-info'> chap 4 </a>
                        <a href='newch.php?id=" . $id . "&ch=5' target='_blank' class='btn btn-xs btn-info'>chap5 </a>
                        <a href='newch.php?id=" . $id . "&ch=6' target='_blank' class='btn btn-xs btn-info'>chapt 6 </a>
                        <a href='newch.php?id=" . $id . "&ch=7' target='_blank' class='btn btn-xs btn-info'> chap 7 </a>
                        <a href='newch.php?id=" . $id . "&ch=8' target='_blank' class='btn btn-xs btn-info'>chap8 </a>
                        <a href='newch.php?id=" . $id . "&ch=idk' target='_blank' class='btn btn-xs btn-info'>unk </a>
