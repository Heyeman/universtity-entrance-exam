    ...
    <body>
     ...
     <h3>Your Answers </h3>
      ...
      <div class='panel-body'> ";
                                    ...
                                    if (!isset($_GET['grade'])) {
                                        $selansas = mysqli_query($mysqli_id, "SELECT * from euee where Subject='$subject' AND Year='$year' and stream!='Social'");
                                    } else {
                                        $selansas = mysqli_query($mysqli_id, "SELECT * from euee where Subject='$subject' AND Year='$year' and GradeHS='$grade' and stream!='Social'");
                                    }
      ...
      <div class='panel-body'> ";
                                    if (!isset($_GET['grade'])) {
                                        $selans = mysqli_query($mysqli_id, "SELECT * from euee where Subject='$subject' AND Year='$year' and stream!='Social'");
                                    } else {
                                        $selans = mysqli_query($mysqli_id, "SELECT * from euee where Subject='$subject' AND Year='$year' and GradeHS='$grade' and stream!='Social'");
                                    }
                                    ...
                                    echo "</td> </table></div></div><a  href='exam.php?subject=" . $subject . "&year=" . $year . "' class='btn btn-default' style='background-color: #7FBD00;color: white;'><span class='fa fa-repeat'></span> Retake Exam<a/> ";
